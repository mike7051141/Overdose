...
//            messages.add(new Message("assistant", "힘든 순간을 보내셨군요. 다음엔 어떻게 하면 다시 사용하지 않을 수 있을지 같이 생각해볼까요?"));
            messages.add(new Message("system", "다음은 정신건강 상담 상황에서의 대화 흐름 예시입니다. 사용자가 질문을 하면 적절한 반응을 제공해주세요." +
                    ...
                    "질문: \"용인에 마약 치료센터 추천해줘.\"\n" +
                    "답변: \"용인정신병원\t경기 용인시 기흥구 중부대로 940\n" +
                    "새로운경기도립정신병원\t경기 용인시 기훙구 중부대로 940\n" +
                    "계요병원\t경기 의왕시 오전로 15\n" +
                    "아주편한병원\t경기 수원시 장안구 경수대로 1111가 있습니다. 사용자의 위치와 가까운 치료센터는 용인 정신병원 입니다.\"\n" +
                    "질문: \"용인에 마약 치료센터 추천해줘.\"\n" +
                    "답변: \"용인정신병원\t경기 용인시 기흥구 중부대로 940 용인정신병원이 사용자의 위치와 가까운 병원입니다.\"\n" ));
            // 세션에 초기 메시지 저장
